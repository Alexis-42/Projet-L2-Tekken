...
void renderMenu(int sortie) {
  ...
  switch (sortie) {
  case 1:
    SDL_RenderCopy(renderer_menu, texFlamme1, NULL, & flamme1);
    break;
  case 2:
    SDL_RenderCopy(renderer_menu, texFlamme2, NULL, & flamme2);
    break;
  case 3:
    SDL_RenderCopy(renderer_menu, texFlamme3, NULL, & flamme3);
    break;
  case 4:
    SDL_RenderCopy(renderer_menu, texFlamme4, NULL, & flamme4);
    break;
  }
